        ...
        >
          ...
          <div className="relative px-5 md:px-8 lg:px-10 pb-8">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-10">
              ...
              <div className="lg:col-span-5">
                ...
                >
                  <div className="relative">
                    <div
                      ...
                      style={{ background: 'linear-gradient(135deg, #C68A7C, #D4AF37)', borderColor: '#2A2A2A' }}
                    >
                      <span className="text-3xl font-display font-bold text-white tracking-wide">FR</span>
                    </div>
                    <div className="absolute -bottom-1.5 -right-1.5 w-7 h-7 rounded-full bg-[#2A2A2A] flex items-center justify-center">
                ...
                >
                  ...
                  <p className="text-xs md:text-sm text-white/60 font-hud tracking-wider uppercase mt-1.5">
                ...
                >
                  {metaPills.map((pill) => {
                    ...
                    return (
                      <span
                        key={pill.label}
                        className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 border border-white/10 text-[11px] font-hud text-white/75"
                      >
                    ...
                    return (
                      <Magnetic key={social.label} range={0.3}>
                        <motion.a
                          ...
                          whileTap={{ scale: 0.95 }}
                          className="w-9 h-9 rounded-full bg-white/10 border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:bg-white/20 hover:border-white/20 transition-colors duration-300 cursor-none"
                ...
                >
                  {quickStats.map((stat) => (
                    <div key={stat.label} className="flex flex-col items-center justify-center py-2.5 rounded-xl bg-white/5 border border-white/10">
                      <span className="font-display text-xl font-semibold text-white leading-none">{stat.value}</span>
                      <span className="font-hud text-[8px] text-white/50 uppercase tracking-widest mt-1">{stat.label}</span>
                    </div>
                  ))}
                </motion.div>
              </div>
              ...
              <div className="lg:col-span-7 flex flex-col">
                ...
                <motion.p
                  ...
                  className="text-sm md:text-base text-white/70 font-sans leading-relaxed text-center lg:text-left mb-5 mt-2 lg:mt-6"
                >
                ...
                >
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="relative z-10 flex items-center gap-1.5">
                            ...
                            <span className={`font-medium tracking-wide text-[11px] md:text-xs ${isActive ? 'text-white' : 'text-white/50'}`}>
                              {tab.label}
                            </span>
                          </span>
                        </button>
                  ...
                  {/* Tab content */}
                  <div ref={constraintsRef} className="overflow-hidden flex-1">
                    <motion.div
                      drag="x"
                    ...
                    >
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-6 min-h-[300px] h-full relative overflow-hidden">
                        ...
                        <AnimatePresence mode="wait">
                          {activeTab === 'story' && (
                            ...
                            >
                              <h3 className="text-lg md:text-xl font-display font-medium text-white tracking-wide flex items-center gap-2">
                                <Compass className="w-5 h-5 text-terracotta" />
                                {t('sections.about.story.title')}
                              </h3>
                              <div className="text-sm text-white/60 font-sans space-y-3 leading-relaxed">
                              ...
                              <div className="relative space-y-7">
                                <div className="relative pl-7 border-l border-terracotta/30">
                                  ...
                                  <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-1">
                                    <h4 className="text-base font-display font-medium text-white">{t('sections.about.experienceTimeline.entry1.company')}</h4>
                                  ...
                                  <p className="text-sm text-white/60 font-sans leading-relaxed mt-1.5">{t('sections.about.experienceTimeline.entry1.description')}</p>
                                </div>
                                <div className="relative pl-7 border-l border-sage/30">
                                  ...
                                  <div className="flex flex-col md:flex-row md:items-baseline md:justify-between mb-1">
                                    <h4 className="text-base font-display font-medium text-white">{t('sections.about.experienceTimeline.entry2.company')}</h4>
                                  ...
                                  <p className="text-sm text-white/60 font-sans leading-relaxed mt-1.5">{t('sections.about.experienceTimeline.entry2.description')}</p>
                                </div>
                              </div>
                            </motion.div>
                          )}
                          ...
                          {activeTab === 'skills' && (
                            ...
                            >
                              ...
                              <div className="space-y-3">
                                <h3 className="text-sm font-hud font-medium text-white/80 tracking-widest uppercase">{t('sections.about.skills.softTitle')}</h3>
                                  ...
                                  {softSkills.map((skill, index) => {
                                    ...
                                    return (
                                      <motion.span
                                        ...
                                        className="flex items-center gap-1.5 px-3 py-1.5 bg-terracotta/15 border border-terracotta/25 text-white/85 text-xs font-hud rounded-full cursor-none transition-colors duration-300 hover:bg-terracotta/25"
                                        data-cursor="magnetic"
                                      >
                              ...
                              <div className="space-y-3">
                                <h3 className="text-sm font-hud font-medium text-white/80 tracking-widest uppercase">{t('sections.about.skills.hardTitle')}</h3>
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-3">
                                  {hardSkills.map((skill, index) => (
                                    <div key={skill.label} className="space-y-1">
                                      <div className="flex items-center justify-between">
                                        <span className="text-xs text-white/75 font-hud">{skill.label}</span>
                    ...
                    {tabOrder.map((tabId) => (
                      <button
                        ...
                        className={`h-1.5 rounded-full transition-all duration-300 cursor-none ${
                          activeTab === tabId ? 'bg-terracotta w-5' : 'bg-white/20 w-1.5'
                        }`}
                        data-cursor="magnetic"
                      />
                    ))}
            ...
            <div className="mt-6 pt-5 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-3">
              <span className="flex items-center gap-2 text-[10px] font-hud text-white/40 tracking-widest uppercase">
                <CheckCircle2 className="w-3.5 h-3.5 text-sage" />
                {t('sections.about.trait')}
              </span>
              <span className="text-[10px] font-hud text-white/30 tracking-widest uppercase">PROFILE_ID // FR-2026</span>
            </div>
          </div>
        </motion.div>
      </div>
