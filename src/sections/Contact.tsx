...
export const Contact = () => {
  ...
  const executeConsoleLogs = async () => {
    const logs = tArray('contact.consoleLogs');
    ...
    try {
      ...
      if (response.ok) {
        setConsoleLogs((prev) => [...prev, t('contact.consoleDone')]);
      ...
      setConsoleLogs((prev) => [...prev, t('contact.error.transmissionFailed')]);
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    setStatus('sending');
    setConsoleLogs([t('contact.consoleInit')]);
    executeConsoleLogs();
  };
      ...
      <div className="w-full max-w-7xl mx-auto z-10 relative">
        ...
        <div className="text-left mb-16 md:mb-20">
          ...
          >
            {t('contact.title')}
            <br />
            <span className="italic font-light text-charcoal-light">{t('contact.titleSuffix')}</span>
          </motion.h2>
        </div>
            ...
            <div className="flex flex-col space-y-4">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-hud text-charcoal-light uppercase tracking-wider">{t('contact.location.label')}</span>
                  <span className="text-sm text-charcoal font-medium font-sans">{t('contact.location.value')}</span>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[10px] font-hud text-charcoal-light uppercase tracking-wider">{t('contact.email.label')}</span>
                  <a 
            ...
            <div className="flex flex-wrap gap-3 pt-2">
              {[
                ...
                { 
                  ...
                  label: 'LinkedIn', 
                  href: 'https://www.linkedin.com/in/fakhul-rohman-nurokhim-b24276411' 
                },
              ].map((soc) => (
                ...
                {status === 'sending' && (
                  ...
                  >
                    <div className="flex items-center space-x-2 text-terracotta font-hud text-xs font-medium uppercase tracking-wider mb-6">
                      ...
                      <span>{t('contact.sending.title')}</span>
                    </div>
